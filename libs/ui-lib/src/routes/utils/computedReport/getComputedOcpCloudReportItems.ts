import type { OcpCloudQuery } from '@koku-ui/api/queries/ocpCloudQuery';
import type { OcpCloudReport, OcpCloudReportItem } from '@koku-ui/api/reports/ocpCloudReports';
