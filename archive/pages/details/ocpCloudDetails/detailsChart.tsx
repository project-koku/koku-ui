      ...
      <TextContent style={styles.freeSpace}>
        <TextList component={TextListVariants.dl}>
          ...
          <TextListItem component={TextListItemVariants.dd}>
            {t(`ocp_cloud_details.bullet.${labelKey}_usage_unused`, {
          ...
          <TextListItem component={TextListItemVariants.dt}>
            {t(`ocp_cloud_details.bullet.${labelKey}_requests_unused_label`)}
          </TextListItem>
          <TextListItem component={TextListItemVariants.dd}>
            {t(`ocp_cloud_details.bullet.${labelKey}_requests_unused`, {
              percentage: formatValue(
