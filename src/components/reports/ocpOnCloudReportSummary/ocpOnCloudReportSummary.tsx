...
interface OcpOnCloudReportSummaryProps extends InjectedTranslateProps {
...
const OcpOnCloudReportSummaryBase: React.SFC<OcpOnCloudReportSummaryProps> = ({
  children,
  detailsLink,
  title,
  subTitle,
...
export { OcpOnCloudReportSummary, OcpOnCloudReportSummaryProps };
