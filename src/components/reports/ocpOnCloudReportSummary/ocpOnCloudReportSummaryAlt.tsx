...
interface OcpOnCloudReportSummaryAltProps extends InjectedTranslateProps {
...
const OcpOnCloudReportSummaryAltBase: React.SFC<
  OcpOnCloudReportSummaryAltProps
> = ({
  children,
  detailsLink,
  status,
...
export { OcpOnCloudReportSummaryAlt, OcpOnCloudReportSummaryAltProps };
