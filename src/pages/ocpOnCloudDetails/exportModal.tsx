...
import {
  ocpOnCloudExportActions,
  ocpOnCloudExportSelectors,
} from 'store/ocpOnCloudExport';
...
interface ExportModalDispatchProps {
  exportReport?: typeof ocpOnCloudExportActions.exportReport;
}
...
> {
  ...
  private getQueryString = () => {
    ...
    const newQuery: OcpOnCloudQuery = {
  ...
  private handleFetchReport = () => {
    ...
    exportReport(OcpOnCloudReportType.cost, this.getQueryString());
  };
