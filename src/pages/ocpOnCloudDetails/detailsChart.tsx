...
interface DetailsChartStateProps {
  cpuReport?: OcpOnCloudReport;
  cpuReportFetchStatus?: FetchStatus;
  memoryReport?: OcpOnCloudReport;
...
>((state, { groupBy, item }) => {
  ...
  const cpuReport = ocpOnCloudReportsSelectors.selectReport(
    state,
    cpuReportType,
    queryString
  );
  const cpuReportFetchStatus = ocpOnCloudReportsSelectors.selectReportFetchStatus(
    state,
    cpuReportType,
    queryString
  );
  const memoryReport = ocpOnCloudReportsSelectors.selectReport(
    state,
    memoryReportType,
    queryString
  );
  const memoryReportFetchStatus = ocpOnCloudReportsSelectors.selectReportFetchStatus(
    state,
    memoryReportType,
    queryString
  );
