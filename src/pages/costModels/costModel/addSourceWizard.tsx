...
class AddSourceWizardBase extends React.Component<Props, AddSourcesStepState> {
  ...
  public render() {
    ...
    return (
      <Modal
        isOpen={isOpen}
        title={intl.formatMessage(messages.CostModelsDetailsAssignSourcesTitle)}
        onClose={onClose}
        variant="large"
        actions={[
          <Button
          ...
          >
            {intl.formatMessage(messages.CostModelsDetailsAssignSourcesLabel)}
          </Button>,
        ...
        <Stack>
          ...
          <StackItem>
            <Grid>
              <GridItem span={2}>
                <TextContent>
                  <Text component={TextVariants.h6}>{intl.formatMessage(messages.NameTitleCase, { count: 1 })}</Text>
                </TextContent>
              </GridItem>
              <GridItem span={10}>
                <TextContent>
              ...
              <GridItem span={2}>
                <TextContent>
                  <Text component={TextVariants.h6}>
                    {intl.formatMessage(messages.CostModelsWizardSourceTypeLabel)}
                  </Text>
                </TextContent>
              </GridItem>
              <GridItem span={10}>
