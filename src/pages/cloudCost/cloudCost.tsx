...
import { listViewOverride, styles, toolbarOverride } from './cloudCost.styles';
import { CostItem } from './costItem';
import { CostToolbar } from './costToolbar';
...
class CloudCost extends React.Component<Props> {
  ...
  public getFilterFields = (groupById: string): any[] => {
    ...
    if (groupById === 'account') {
      return [
        {
          id: 'account',
          title: t('cloud_cost.filter.account_select'),
          placeholder: t('cloud_cost.filter.account_placeholder'),
          filterType: 'text',
        },
      ];
      ...
      return [
        {
          id: 'service',
          title: t('cloud_cost.filter.service_select'),
          placeholder: t('cloud_cost.filter.service_placeholder'),
          filterType: 'text',
        },
      ];
      ...
      return [
        {
          id: 'region',
          title: t('cloud_cost.filter.region_select'),
          placeholder: t('cloud_cost.filter.region_placeholder'),
          filterType: 'text',
        },
      ];
    }
      ...
      return [
        {
          id: 'account_alias',
          isNumeric: false,
          title: t('cloud_cost.order.name'),
        },
        {
          id: 'total',
          isNumeric: true,
          title: t('cloud_cost.order.cost'),
        },
      ];
    } else if (groupById === 'service') {
      return [
  ...
  public render() {
    ...
    return (
      <div className={css(styles.cloudCostPage)}>
        <header className={css(styles.header)}>
          <div>
            <Title size="2xl">{t('cloud_cost.title')}</Title>
        ...
        <div className={css(styles.content)}>
          <div className={css(styles.toolbarContainer)}>
            <div className={toolbarOverride}>
              <CostToolbar
                exportText={t('cloud_cost.export_link')}
          ...
          <div className={listViewOverride}>
            <ListView>
              <ListView.Item
                key="header_item"
                heading={t('cloud_cost.name_column_title', {
                  groupBy: groupById,
                })}
                checkboxInput={
                  <input
                ...
                additionalInfo={[
                  <ListView.InfoItem key="1">
                    <strong>{t('cloud_cost.change_column_title')}</strong>
                  </ListView.InfoItem>,
                ]}
                actions={[
                  <ListView.InfoItem key="2">
                    <strong>
                      {t('cloud_cost.cost_column_title')}
                      {Boolean(report) && (
                        <React.Fragment>
                          {t('cloud_cost.cost_column_subtitle', {
