...
class DetailsTableBase extends React.Component<DetailsTableProps> {
  ...
  private initDatum = () => {
    ...
    const columns = groupByTagKey
      ? [
          {
            title: t('ibm_details.tag_column_title'),
          },
          {
            title: t('ibm_details.change_column_title'),
          },
          {
            orderBy: 'cost',
            title: t('cost', { total }),
      ...
      : [
          {
            orderBy: groupById,
            title: t('ibm_details.name_column_title', { groupBy: groupById }),
            transforms: [sortable],
          },
          {
            title: t('ibm_details.change_column_title'),
  ...
  private getEmptyState = () => {
    ...
    return (
      <EmptyState>
        ...
        <EmptyStateBody>{t('ibm_details.empty_state')}</EmptyStateBody>
      </EmptyState>
    );
  };
