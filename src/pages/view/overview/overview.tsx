...
import { Perspective } from 'pages/view/components/perspective/perspective';
import AwsCloudDashboard from 'pages/view/dashboard/awsCloudDashboard/awsCloudDashboard';
import AwsDashboard from 'pages/view/dashboard/awsDashboard/awsDashboard';
import AzureCloudDashboard from 'pages/view/dashboard/azureCloudDashboard/azureCloudDashboard';
import AzureDashboard from 'pages/view/dashboard/azureDashboard/azureDashboard';
import GcpDashboard from 'pages/view/dashboard/gcpDashboard/gcpDashboard';
import OcpCloudDashboard from 'pages/view/dashboard/ocpCloudDashboard/ocpCloudDashboard';
import OcpDashboard from 'pages/view/dashboard/ocpDashboard/ocpDashboard';
import OcpSupplementaryDashboard from 'pages/view/dashboard/ocpSupplementaryDashboard/ocpSupplementaryDashboard';
import OcpUsageDashboard from 'pages/view/dashboard/ocpUsageDashboard/ocpUsageDashboard';
