...
export const selectOcpCostOverviewState = (state: RootState) =>
  state[ocpCostOverviewStateKey];

export const selectWidgets = (state: RootState) =>
  selectOcpCostOverviewState(state).widgets;
...
export const selectCurrentWidgets = (state: RootState) =>
  selectOcpCostOverviewState(state).currentWidgets;
