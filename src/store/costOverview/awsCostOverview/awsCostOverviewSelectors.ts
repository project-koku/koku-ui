...
export const selectAwsCostOverviewState = (state: RootState) =>
  state[awsCostOverviewStateKey];

export const selectWidgets = (state: RootState) =>
  selectAwsCostOverviewState(state).widgets;
...
export const selectCurrentWidgets = (state: RootState) =>
  selectAwsCostOverviewState(state).currentWidgets;
