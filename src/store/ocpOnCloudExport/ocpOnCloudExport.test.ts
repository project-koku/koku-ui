jest.mock('api/ocpOnCloudExport');
...
import * as actions from './ocpOnCloudExportActions';
import { ocpOnCloudExportReducer, stateKey } from './ocpOnCloudExportReducer';
import * as selectors from './ocpOnCloudExportSelectors';

const createExportStore = createMockStoreCreator({
  [stateKey]: ocpOnCloudExportReducer,
});
