...
export const setWidgetTab = createStandardAction('ocpCloudDashboard/widget/tab')<{
  id: number;
  tab: OcpCloudDashboardTab;
}>();

export const changeWidgetTab = (id: number, tab: OcpCloudDashboardTab): ThunkAction => {
  return dispatch => {
