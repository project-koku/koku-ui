...
export const selectOcpHistoricalDataState = (state: RootState) =>
  state[ocpHistoricalDataStateKey];

export const selectWidgets = (state: RootState) =>
  selectOcpHistoricalDataState(state).widgets;
...
export const selectCurrentWidgets = (state: RootState) =>
  selectOcpHistoricalDataState(state).currentWidgets;
