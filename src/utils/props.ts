...
export const accountKey = 'account'; // Account key for group_by
...
export const regionKey = 'region'; // Region key for group_by
export const serviceKey = 'service'; // Service key for group_by
...
export const classificationProject = 'project'; // Classification for project costs
