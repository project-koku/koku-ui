import { useOnPremAddNotification } from '@koku-ui/ui-lib/onPremNotificationsHost';
import {
  Alert,
  Breadcrumb,
  BreadcrumbItem,
...
import { getApiErrorMessage, getSource, pauseSource, resumeSource } from 'api/entities';
...
const SourceDetail: React.FC<SourceDetailProps> = ({ uuid, onBack, canWrite = false }) => {
  const intl = useIntl();
  const addNotification = useOnPremAddNotification();
