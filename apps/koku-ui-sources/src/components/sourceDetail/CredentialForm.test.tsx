...
describe('CredentialForm', () => {
  ...
  it('renders AWS credentials as editable', () => {
    renderWithIntl(<CredentialForm source={awsSource} />);
  ...
  it('renders Azure credentials with secret field masked', () => {
    renderWithIntl(<CredentialForm source={azureSource} />);
  ...
  it('renders GCP credentials', () => {
    renderWithIntl(<CredentialForm source={gcpSource} />);
  ...
  it('returns null for unknown source type with no credentials', () => {
    ...
    const { container } = renderWithIntl(<CredentialForm source={unknownSource} />);
  ...
  it('calls onSave with form values when Save is clicked', async () => {
    ...
    renderWithIntl(<CredentialForm source={awsSource} onSave={onSave} />);
