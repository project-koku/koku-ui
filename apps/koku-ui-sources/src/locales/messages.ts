...
export default defineMessages({
  ...
  sourceTypeAWSLabel: {
    id: 'sources.sourceTypeAWSLabel',
    defaultMessage: 'Amazon Web Services',
  },
  sourceTypeAzureLabel: {
    id: 'sources.sourceTypeAzureLabel',
    defaultMessage: 'Microsoft Azure',
  },
  sourceTypeGCPLabel: {
    id: 'sources.sourceTypeGCPLabel',
  ...
  wizardSelectTypeTitle: {
    id: 'sources.wizardSelectTypeTitle',
    defaultMessage: 'Select integration type',
  },
  wizardSelectTypeFieldLabel: {
    id: 'sources.wizardSelectTypeFieldLabel',
    defaultMessage: 'Select an integration type',
  },
  ...
  wizardTitleAws: {
    id: 'sources.wizardTitleAws',
    defaultMessage: 'Add an Amazon Web Services integration',
  },
  wizardTitleAzure: {
    id: 'sources.wizardTitleAzure',
    defaultMessage: 'Add a Microsoft Azure integration',
  },
  wizardTitleGcp: {
    id: 'sources.wizardTitleGcp',
    defaultMessage: 'Add a Google Cloud Platform integration',
  },
  wizardExitTitle: {
