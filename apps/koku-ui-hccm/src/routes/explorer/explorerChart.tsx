...
import type { ChartDatum } from 'routes/components/charts/common/chartDatum';
import {
...
class ExplorerChartBase extends React.Component<ExplorerChartProps, ExplorerChartState> {
  ...
  private createReportDatum = (
    ...
    return {
      ...
      ...(value === null && { _y: 0 }), // Force "no data" tooltips. See https://redhat.atlassian.net/browse/COST-1765
