...
describe('RateContent interactions', () => {
  ...
  test('changing name and description updates inputs', () => {
    renderContent(<RateContent priceList={samplePriceList} rateIndex={0} />);
  ...
  test('save merges tiered rate payload for existing CPU rate', () => {
    ...
    renderContent(<RateContent ref={ref} onSave={onSave} priceList={samplePriceList} rateIndex={0} />);
