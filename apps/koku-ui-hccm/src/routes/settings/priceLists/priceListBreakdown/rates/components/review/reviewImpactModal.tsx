...
interface ReviewImpactModalOwnProps {
  isOpen?: boolean;
  onClose?: () => void;
  onConfirm?: () => void;
...
type ReviewImpactModalProps = ReviewImpactModalOwnProps;

const ReviewImpactModal: React.FC<ReviewImpactModalProps> = ({ isOpen, onClose, onConfirm, priceList }) => {
  const intl = useIntl();
