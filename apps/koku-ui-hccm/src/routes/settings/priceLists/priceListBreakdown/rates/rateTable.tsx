...
import { RateActions } from 'routes/settings/priceLists/priceListBreakdown/rates/components/actions';
import { formatCurrencyRate } from 'utils/format';

import { styles } from './rateTable.styles';

interface RateTableOwnProps {
  canWrite?: boolean;
  filterBy?: any;
  isDisabled?: boolean;
  isDispatch?: boolean;
...
type RateTableProps = RateTableOwnProps;
