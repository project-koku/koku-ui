...
jest.mock('routes/settings/priceLists/priceListBreakdown/rates/components/delete', () => {
...
jest.mock('routes/settings/priceLists/priceListBreakdown/rates/components/edit', () => {
  const React = require('react');
  return {
