...
import type { DeleteRateHandle } from 'routes/settings/priceLists/priceListBreakdown/rates/components/delete';
import { DeleteRate } from 'routes/settings/priceLists/priceListBreakdown/rates/components/delete';
import type { EditRateHandle } from 'routes/settings/priceLists/priceListBreakdown/rates/components/edit';
import { EditRate } from 'routes/settings/priceLists/priceListBreakdown/rates/components/edit';
