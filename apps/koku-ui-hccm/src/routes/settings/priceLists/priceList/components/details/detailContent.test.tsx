...
const getCalendarOverride = (): CalendarPickOverride | undefined =>
  (globalThis as { __detailContentCalendarDates?: CalendarPickOverride }).__detailContentCalendarDates;

const setCalendarOverride = (value: CalendarPickOverride | undefined) => {
  (globalThis as { __detailContentCalendarDates?: CalendarPickOverride }).__detailContentCalendarDates = value;
};
...
describe('DetailContent', () => {
  ...
  test('renders currency as read-only text with tooltip in edit mode', () => {
    renderDetails(<DetailContent isEditDetails priceList={basePriceList} />);
  ...
  test('renders currency picker when not editing existing details (add flow)', () => {
    renderDetails(<DetailContent priceList={basePriceList} />);
  ...
  test('calls onDisabled when unsaved / validation state changes', async () => {
    ...
    renderDetails(
      <DetailContent isEditDetails onDisabled={onDisabled} onSave={jest.fn()} priceList={basePriceList} />
    );
  ...
  test('imperative save calls onSave with formatted payload', async () => {
    ...
    renderDetails(
      <DetailContent ref={ref} isEditDetails onSave={onSave} priceList={basePriceList} />
    );
  ...
  test('renders with minimal price list (missing optional dates)', () => {
    ...
    renderDetails(<DetailContent isEditDetails priceList={minimal} />);
  ...
  test('save includes default validity dates when API omitted effective_start/end', async () => {
    ...
    const ref = createRef<DetailContentHandle>();
    renderDetails(
      <DetailContent ref={ref} isEditDetails onSave={onSave} priceList={minimal} />
    );
