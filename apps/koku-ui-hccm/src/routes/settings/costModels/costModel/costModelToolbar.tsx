...
import { CreateCostModelAction } from 'routes/settings/costModels/costModelCreate/components/actions';
...
interface CostModelToolbarOwnProps {
  canWrite?: boolean;
...
type CostModelToolbarProps = CostModelToolbarOwnProps;

const CostModelToolbar: React.FC<CostModelToolbarProps> = ({
  canWrite,
  isAllSelected,
  isDisabled,
  itemsPerPage,
  ...
  const getActions = () => {
    return <CreateCostModelAction canWrite={canWrite} isDisabled={isDisabled} />;
  };
