...
type OrderPriceListToolbarProps = OrderPriceListToolbarOwnProps;

const OrderPriceListToolbar: React.FC<OrderPriceListToolbarProps> = ({
  canWrite,
  costModel,
  isAllSelected,
  isDisabled,
