...
import { ReviewCostModelModal } from 'routes/settings/costModels/costModelBreakdown/components/review';
...
const DeleteCostModel = forwardRef<DeleteCostModelHandle, DeleteCostModelProps>((props, ref) => {
  ...
  return (
    <>
      <ReviewCostModelModal costModel={costModel} isOpen={isReviewModalOpen} onClose={handleOnReviewModalClose} />
