...
jest.mock('routes/settings/costModelsDeprecated/components/hoc/withPriceListSearch', () => ({
	__esModule: true,
...
jest.mock('routes/settings/costModelsDeprecated/components/priceListToolbar', () => ({
	__esModule: true,
...
jest.mock('routes/settings/costModelsDeprecated/components/rateTable', () => ({
	__esModule: true,
...
jest.mock('routes/settings/costModelsDeprecated/components/paginationToolbarTemplate', () => ({
	__esModule: true,
