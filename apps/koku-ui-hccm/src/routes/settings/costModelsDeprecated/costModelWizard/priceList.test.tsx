...
jest.mock('routes/settings/costModelsDeprecated/components/rateForm/index', () => ({
  __esModule: true,
  transformFormDataToRequest: () => ({ metric: { label_metric: 'cpu', label_measurement: 'Hrs', label_measurement_unit: 'hrs' } }),
}));

jest.mock('routes/settings/costModelsDeprecated/components/addPriceList', () => ({ __esModule: true, default: (props: any) => (
  <div>
