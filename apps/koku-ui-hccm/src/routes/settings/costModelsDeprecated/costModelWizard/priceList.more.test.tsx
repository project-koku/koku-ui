...
jest.mock('routes/settings/costModelsDeprecated/components/addPriceList', () => ({ __esModule: true, default: ({ submitRate, cancel }: any) => (
	<div>
...
jest.mock('routes/settings/costModelsDeprecated/components/rateForm/index', () => ({ __esModule: true, transformFormDataToRequest: () => ({ rate: 1 }) }));
