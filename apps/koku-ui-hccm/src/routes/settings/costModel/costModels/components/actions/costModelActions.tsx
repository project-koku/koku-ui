...
import type { DeleteCostModelHandle } from 'routes/settings/costModel/costModels/components/delete';
import { DeleteCostModel } from 'routes/settings/costModel/costModels/components/delete';
import type { EditCostModelHandle } from 'routes/settings/costModel/costModels/components/edit';
import { EditCostModel } from 'routes/settings/costModel/costModels/components/edit';
