...
interface ReviewCostModelModalOwnProps {
  costModel: CostModel;
  isOpen?: boolean;
  onClose?: () => void;
}

type ReviewCostModelModalProps = ReviewCostModelModalOwnProps;

const ReviewCostModelModal: React.FC<ReviewCostModelModalProps> = ({ costModel, isOpen, onClose }) => {
  const intl = useIntl();
