...
import { styles } from './priceListDetailsTable.styles';

interface PriceListDetailsTableOwnProps {
  canWrite?: boolean;
  filterBy?: any;
  isDisabled?: boolean;
  isLoading?: boolean;
...
type PriceListDetailsTableProps = PriceListDetailsTableOwnProps;

const PriceListDetailsTable: React.FC<PriceListDetailsTableProps> = ({
  canWrite,
  filterBy,
  isDisabled,
  isLoading,
