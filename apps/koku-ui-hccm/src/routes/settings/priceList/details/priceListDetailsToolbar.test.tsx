...
describe('PriceListDetailsToolbar', () => {
  ...
  test('renders create action and deprecated switch', () => {
    renderWithStore(<PriceListDetailsToolbar {...baseProps} canWrite isDisabled={false} />);
  ...
  test('notifies parent when deprecated switch toggles', () => {
    ...
    renderWithStore(<PriceListDetailsToolbar {...baseProps} onShowDeprecated={onShowDeprecated} />);
  ...
  test('invokes onCreate when create is clicked and writable', () => {
    ...
    renderWithStore(<PriceListDetailsToolbar {...baseProps} canWrite isDisabled={false} onCreate={onCreate} />);
