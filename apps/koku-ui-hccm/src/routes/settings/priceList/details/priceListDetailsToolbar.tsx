...
interface PriceListDetailsToolbarOwnProps {
  canWrite?: boolean;
...
type PriceListDetailsToolbarProps = PriceListDetailsToolbarOwnProps;

const PriceListDetailsToolbar: React.FC<PriceListDetailsToolbarProps> = ({
  canWrite,
  isAllSelected,
  isDisabled,
  isShowDeprecated,
...
export { PriceListDetailsToolbar };
