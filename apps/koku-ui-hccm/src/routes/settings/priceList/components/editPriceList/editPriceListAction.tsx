...
interface EditPriceListActionOwnProps {
  canWrite?: boolean;
  isDisabled?: boolean;
  onClose?: () => void;
...
type EditPriceListActionProps = EditPriceListActionOwnProps;

const EditPriceListAction: React.FC<EditPriceListActionProps> = ({ canWrite, isDisabled, onClose, priceList }) => {
  ...
  return (
    <>
      {getActions()}
      <EditPriceListModal isOpen={isOpen} onClose={handleOnClose} priceList={priceList} />
    </>
  );
};

export { EditPriceListAction };
