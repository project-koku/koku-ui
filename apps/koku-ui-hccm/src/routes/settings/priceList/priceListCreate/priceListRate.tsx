...
import { RateTable, RateToolbar } from 'routes/settings/priceList/priceListBreakdown/rates';
...
interface PriceListRateOwnProps {
  canWrite?: boolean;
...
export interface PriceListRateMapProps {
  pageNumber?: number;
  perPage?: number;
  priceList: PriceListData; // Price list without filters and pagination for editing
  query?: Query;
...
const PriceListRate: React.FC<PriceListRateProps> = ({ canWrite, onAdd, onDelete, onEdit, priceList }) => {
  const intl = useIntl();
