...
import { styles } from './priceListsTable.styles';

interface PriceListsTableOwnProps {
  canWrite?: boolean;
  filterBy?: any;
  isDisabled?: boolean;
  isLoading?: boolean;
...
type PriceListsTableProps = PriceListsTableOwnProps;

const PriceListsTable: React.FC<PriceListsTableProps> = ({
  canWrite,
  filterBy,
  isDisabled,
  isLoading,
