...
import { DeletePriceListModal } from 'routes/settings/priceList/priceLists/delete';
import { DeprecatePriceListModal } from 'routes/settings/priceList/priceLists/deprecate';
