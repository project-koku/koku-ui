...
type SelectTableProps = SelectTableOwnProps & RouterComponentProps & WrappedComponentProps;

class SelectTable extends React.Component<SelectTableProps, any> {
...
export default injectIntl(withRouter(SelectTable));
