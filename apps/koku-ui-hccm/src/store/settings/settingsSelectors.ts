...
export const selectSettingsFetchStatus = (state: RootState, settingsType: SettingsType, reportQueryString: string) =>
  selectSettingsState(state)?.status.get(getFetchId(settingsType, reportQueryString));

export const selectSettingsNotification = (state: RootState, settingsType: SettingsType, reportQueryString: string) =>
  selectSettingsState(state)?.notification?.get(getFetchId(settingsType, reportQueryString));
