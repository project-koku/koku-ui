...
jest.mock('routes/settings/costModelsDeprecated/components/errorState', () => ({ __esModule: true, SourceStepErrorState: (props: any) => <button onClick={props.onRefresh}>error</button> }));
